...
class Voyage():
    def __init__(self, start_of_journey = "", departure_time_out = "", arriving_abroad = "", arrival_time_abroad = "",fligth_number_out = "", departing_to_RVK = "", departure_time_home = "", arrival_time_home = "", aircraft_ID = "", captain = "", co_pilot = "", fsm = "", fa1 = "", fa2 = "", flight_number = ""):
